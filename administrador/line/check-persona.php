...
error_reporting(0);
	if(isset($_POST["documento"]) ){
		...
		$doc		=	$_POST['documento'];
						...
						$url = "http://172.17.0.78:89/ws001.php?documento=$doc";
						$ch = curl_init($url);
						...
						<form name="gotoPersona" action="persona.php" method="POST">
								...
								<input class="input1" type="hidden" name="celular" 		 	 value="<?php echo $celular; ?>">
