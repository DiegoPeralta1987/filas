              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          ...
                          <h1 class="box-title">Liberar Lugares</h1><br>
                          <h4 style="border-width:4px; border-style:solid; color:orange;"><font color="red" >Tener en cuenta que al presionar boton "rojo" 
                          se liberan los lugares reservados de las personas que no llegaron a tiempo. Y luego se procede ala carga de la personas presenciales </font>
                           </h4>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/cancelacion.js"></script>
<script>
