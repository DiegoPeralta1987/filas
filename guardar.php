...
/////si todo esta bien actualiza el cod_lugar
      ...
      header ("Location:  https://reservas.cfa.org.py/gracias.php?grupo=$varibale&lugar=$ideventos&ci_persona=$documento&idreserva=$idreserva&correo=$correo&nombre=$nombre");
        ...
        $sql1="DELETE FROM reserva_detalle WHERE idreserva_cabecera='$idreserva' and idservicio='$idservicio'";
        $res3 = $mysqli->query($sql1);

       $sql2="DELETE FROM reserva_cabecera WHERE idreserva_cabecera='$idreserva' and idservicio='$idservicio'";
